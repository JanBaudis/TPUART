...
\item[\hyperlink{todo__todo000005}{Todo}]Change the U\+A\+R\+T-\/\+Functions -\/ add an extra value for the Port used and not an simple string to select it in the Function for both Init Functions \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000009}{Todo}]Think about if volatile for the U\+S\+A\+R\+T\+\_\+\+D\+A\+T\+A\+\_\+\+TP is needed!\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000011}{Todo}]Think about if volatile for the U\+S\+A\+R\+T\+\_\+\+D\+A\+T\+A\+\_\+\+PC is needed!\end{DoxyRefDesc}
...
Referenced by ack\+Info(), enter\+\_\+shell(), I\+S\+R(), main(), and setaddress().
